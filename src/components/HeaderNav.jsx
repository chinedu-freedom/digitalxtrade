    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
      <div className="max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-16 h-20 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            <span className="text-2xl font-black tracking-wider text-slate-900 leading-none">
              DIGITAL<span className="text-[#0072ce]">X</span>TRADE
            </span>
          </div>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-8 lg:gap-10">
          <Link
            href="/about"
            className="text-sm font-bold text-[#0072ce] hover:text-[#005596] transition-colors"
          >
            About Us
          </Link>
          <Link
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/login"
            className="border border-[#0085d0] text-[#0072ce] hover:text-[#38bdf8] hover:bg-slate-50 transition-all px-4 py-2 rounded text-xs font-black tracking-wider uppercase flex items-center gap-1.5 shadow-xs group"
          >
            <span>LOGIN</span>
            <svg className="w-4 h-4 text-[#0072ce] group-hover:text-[#38bdf8] transition-colors shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
