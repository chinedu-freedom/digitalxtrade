...
export default function LoginPage() {
  ...
  const handleLogin = (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Navigate or handle authentication
    }, 1500);
  };
        ...
        <div className="relative z-10 w-full max-w-[500px] bg-white rounded-lg shadow-2xl p-8 md:p-12 border border-slate-100 my-auto text-center">
          ...
          <form onSubmit={handleLogin} className="space-y-5 text-left">
            <div>
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded px-4 py-3.5 text-sm md:text-base text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-[#0085d0] focus:ring-1 focus:ring-[#0072ce] transition-all"
              />
            </div>
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#0085d0] hover:bg-[#0072ce] text-white font-bold py-3.5 rounded text-sm md:text-base tracking-wider uppercase transition-colors shadow-md disabled:opacity-70 flex items-center justify-center"
              >
          ...
          <div className="mt-8">
            <Link
              ...
              className="text-[#0085d0] hover:underline font-bold text-sm md:text-base transition-colors"
            >
